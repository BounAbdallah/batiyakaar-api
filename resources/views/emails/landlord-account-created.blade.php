...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p>Bonjour {{ $landlord->prenom }} {{ $landlord->nom }},</p>

        <p>Votre compte bailleur a été créé avec succès par <strong>{{ $agence->raison_sociale }}</strong>.</p>
        ...
        <p>Vous pouvez maintenant vous connecter à votre espace bailleur pour :</p>
        <ul>
            <li>Consulter vos biens immobiliers</li>
            <li>Suivre vos revenus locatifs</li>
            <li>Gérer vos contrats de location</li>
            <li>Consulter les paiements de loyers</li>
            <li>Suivre les incidents et demandes de maintenance</li>
        </ul>
